...
import { Truck, ShieldCheck, Headphones, CreditCard, Star, ArrowRight, ChevronDown, ChevronUp, BadgeCheck } from "lucide-react";
...
import customNotebookBg from "@/assets/custom-notbook.jpg";
import visitingCardsBg from "@/assets/visiting-cards.jpg";
import noticePrintingBg from "@/assets/notice-printing.jpg";
import weddingCardsBg from "@/assets/wedding-cards.jpg";
...
const Index = () => {
  ...
  const renderCategoryCard = (slot: string) => {
    ...
    const gradient = `linear-gradient(135deg, #0E1325 0%, #1B2236 100%)`;
    ...
    return (
      <Link
        ...
        className={cn(
          ...
          "min-h-[160px] sm:min-h-[220px] md:min-h-[240px]",
          "flex flex-col justify-between p-3.5 sm:p-6 h-full",
          "transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white/70"
        )}
        style={{
          background: backgroundImage
            ? `linear-gradient(to bottom, rgba(0, 0, 0, 0.85) 0%, rgba(0, 0, 0, 0.55) 100%) center / cover no-repeat, url('${backgroundImage}') center / cover no-repeat, ${gradient} center / cover no-repeat`
        ...
        <div className="relative z-10 flex flex-col h-full justify-between text-white">
          ...
          <div className="space-y-2 sm:space-y-4">
            ...
            <div className="flex items-center gap-2">
              <div className="w-1 h-5 sm:h-6 bg-white/60 rounded-full" />
            ...
            {/* Title */}
            <h3 className="text-base sm:text-2xl md:text-3xl font-bold text-white leading-tight">
              {displayTitle}
            </h3>
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section id="shop-by-category" className="pt-0 pb-8 sm:pb-12 md:pb-16 lg:pb-20 bg-white dark:bg-slate-900 scroll-mt-20">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
          ...
          {/* Mobile Category Cards (2 columns) */}
          <div className="grid grid-cols-2 gap-3 md:hidden mb-8 [&>*:last-child:nth-child(odd)]:col-span-2 [&>*:last-child:nth-child(odd)]:justify-self-center [&>*:last-child:nth-child(odd)]:w-[calc(50%-0.375rem)]">
          ...
          <div className="hidden md:block">
            <div className="grid category-mosaic">
              {/* Row 1 */}
              {renderCategoryCard("grid1-c1")}
              {renderCategoryCard("grid1-c2")}
              {renderCategoryCard("grid1-c3")}
      ...
      <section className="py-16 sm:py-20 bg-white dark:bg-slate-950">
        <div className="container mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-center mb-10 sm:mb-12 space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 dark:text-slate-100 mb-2">Stories of Success</h2>
            <p className="text-muted-foreground dark:text-slate-400 text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {testimonials.map((t, i) => (
              <div
                key={i}
                className="bg-white dark:bg-slate-900 p-6 sm:p-7 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col gap-4 h-full relative"
              >
                ...
                <div className="flex justify-between items-start">
                  <div className="flex gap-3">
                    ...
                    <div className="relative">
                      <div className="w-10 h-10 rounded-full bg-[#040D1F] flex items-center justify-center text-white font-bold text-sm">
                        {t.name.charAt(0)}
                      </div>
                      <div className="absolute -bottom-1 -right-1 bg-white dark:bg-slate-900 rounded-full p-[2px]">
                        <div className="bg-[#040D1F] rounded-full p-[2px]">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex text-[#040D1F] dark:text-white gap-0.5">
                    {[1, 2, 3, 4, 5].map((star) => (
            ...
            {faqs.length > 6 && (
              <div className="flex justify-center py-4 sm:py-5 md:py-6 border-t border-border">
                <Button
                  ...
                  className="show-more-btn flex items-center gap-2 text-sm sm:text-base font-semibold text-slate-900 !bg-transparent hover:!bg-transparent hover:!text-slate-900 transition-colors"
                >
                  {showAllFaqs ? (
                    <>
                      Show Less
