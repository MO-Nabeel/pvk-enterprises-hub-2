        ...
        <div className="min-h-screen w-full relative overflow-hidden font-sans">
            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
                ...
                <div className="w-full max-w-[420px] p-8 md:p-12 rounded-[30px] bg-white/10 backdrop-blur-xl border border-white/20 shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] flex flex-col">
                    ...
                    <h2 className="text-3xl font-bold text-center text-gray-800 mb-10 tracking-tight">REGISTER</h2>

                    <form onSubmit={handleSubmit} className="space-y-8">

                        {/* Name Input */}
                        <div className="relative group">
                            <User className="absolute right-0 top-2 h-5 w-5 text-gray-500 group-focus-within:text-gray-800 transition-colors" />
                            <Input
                                id="name"
                                type="text"
